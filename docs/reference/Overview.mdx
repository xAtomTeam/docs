...
<DocCardList items={[{
          ...
          items: [{
          type:"link",
          href:"/docs/reference/components/WFComponent",
          label:"",
        }],
        }
        ]} ></DocCardList>
...
<DocCardList items={[
        {
          ...
          items: [{
          type:"link",
          href:"/docs/reference/routing/WFRoute",
          label:"",
        }],
        },{
          type: "category",
          ...
          items: [{
          type:"link",
          href:"/docs/reference/auth/WFAuth",
          label:"",
        }],
        }
        ]} ></DocCardList>
...
<DocCardList items={[
       {
          ...
          items: [{
          type:"link",
          href:"/docs/reference/utils/onReady",
          label:"",
        }],
        }
        ]} ></DocCardList>
...
<DocCardList items={[
      {
          ...
          items: [{
          type:"link",
          href:"/docs/reference/services/RESTAPIClient",
          label:"",
        }],
        }
        ]} ></DocCardList>
